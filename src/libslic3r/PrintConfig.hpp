...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionFloat,                bridge_spacing))
    ((ConfigOptionFloat,                bridge_fill_flow_ratio))
    ((ConfigOptionFloat,                bridge_fill_spacing))
...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    ((ConfigOptionBool,                tower_cap))
    ((ConfigOptionBool,                tower_c))
    ((ConfigOptionBool,                tower_r))
    ((ConfigOptionBool,                tower_s))
