...
static std::vector<std::string> s_Preset_print_options {
    ...
    "bridge_speed", "gap_fill_speed", "coast_speed", "coast_length", "seam_gap", "coast_cap", "gap_fill_enabled", "travel_speed", "travel_speed_z", "first_layer_speed", "first_layer_speed_over_raft", "perimeter_acceleration", "infill_acceleration",
